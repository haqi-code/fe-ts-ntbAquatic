...
export default function AtletAdminIndependenPage({ role }: AtletRoleProps) {
    const { atlets, error, loading, navigate} = useAtlet(role)

    return (
        <div className="p-6 max-w-6xl mx-auto text-white">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-xl text-gray-800 font-bold">Master Data Atlet</h1>
                <button onClick={() => navigate("/admin-independen/tambah-atlet")} className="px-4 py-2 bg-blue-600 rounded hover:bg-blue-700 cursor-pointer">
                    Tambah Atlet
                </button>
            </div>
